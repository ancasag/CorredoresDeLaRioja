...
class CarreraRepositoryTest extends KernelTestCase {
	...
	public function testCarrerasEsCarrerasDisputadasYNoDisputadas() {
		$carreras = $this->repository->buscaTodasLasCarreras();
		$carrerasNoDisputadas = $this->repository->buscaCarrerasPorDisputar();
		$carrerasDisputadas = $this->repository->buscaCarrerasDisputadas();
	...
	public function testAnadirCarrera() {
		...
		$this->repository->creaCarrera($carrera);

		$this->assertNotNull($this->repository->buscaCarreraBySlug('carrera-montes-anguiano'));
	}
